          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-lg text-gray-700 mb-6">
                Akomapa Health Foundation was established in 2010 with a vision to create a world where quality healthcare is accessible to all people, regardless of their location or economic status.
              </p>
              <p className="text-lg text-gray-700 mb-6">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              ...
              <h3 className="text-xl font-bold mb-3">Access to Care</h3>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              ...
              <h3 className="text-xl font-bold mb-3">Health Education</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              ...
              <h3 className="text-xl font-bold mb-3">Healthcare Workforce</h3>
              <p className="text-gray-600">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Link href="/about/partners" className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              <h3 className="text-xl font-bold mb-2">Partners & Affiliations</h3>
