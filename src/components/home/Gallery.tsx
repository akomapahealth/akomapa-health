...
const defaultGalleryItems: GalleryItem[] = [
  ...
  },
  {
    ...
    alt: "Faculty supervisor walking a student through a patient consultation at the Akomapa pilot clinic",
    category: "faculty",
  },
  {
    id: 12,
    src: "/gallery/gallery-pic-12.jpg",
    alt: "Treatment room set up for student-led care at the Winneba pilot clinic",
    category: "clinics",
  },
  {
    id: 13,
    src: "/gallery/gallery-pic-13.jpg",
    alt: "Faculty mentor debriefing students after community outreach in Saltpond",
    category: "faculty",
  },

  {
    ...
    alt: "Clinical skills practice session with faculty oversight at the pilot clinic",
    category: "faculty",
  },
  {
    id: 15,
    src: "/gallery/gallery-pic-15.JPG",
    alt: "Interprofessional team huddle planning care during a busy clinic day",
    category: "faculty",
  },
  {
    id: 16,
    src: "/gallery/gallery-pic-16.JPG",
    alt: "Faculty demonstrating examination technique to students in the training room",
    category: "faculty",
  },
  {
    id: 17,
    src: "/gallery/gallery-pic-17.JPG",
    alt: "Students and faculty reviewing charts together at the Winneba clinic",
    category: "faculty",
  },
  {
    id: 18,
    src: "/gallery/gallery-pic-18.JPG",
    alt: "Community health education led by faculty and student volunteers outdoors",
    category: "faculty",
  },
  {
    id: 19,
    src: "/gallery/gallery-pic-19.JPG",
    alt: "Hands-on equipment training with faculty supervision in the clinic",
    category: "faculty",
  },
  {
    id: 20,
    src: "/gallery/gallery-pic-20.JPG",
    alt: "Faculty and students coordinating supplies before a mobile screening day",
    category: "faculty",
  },
  {
    id: 21,
    src: "/gallery/gallery-pic-21.JPG",
    alt: "Small-group teaching moment between faculty and medical students in Ghana",
    category: "faculty",
  },
  {
    id: 22,
    src: "/gallery/gallery-pic-22.JPG",
    alt: "Faculty observer supporting students during a supervised patient encounter",
    category: "faculty",
  },
  {
    id: 23,
    src: "/gallery/gallery-pic-23.JPG",
    alt: "End-of-day reflection circle with faculty and student clinicians",
    category: "faculty",
  },

  {
    ...
    alt: "Faculty speaker addressing students at an Akomapa training session",
    category: "faculty",
  },
];
