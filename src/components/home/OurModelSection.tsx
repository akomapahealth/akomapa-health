      ...
      <div className="relative mt-14">
        ...
        <ol className="grid gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-5">
          {components.map((item, index) => (
            <FadeIn key={item.title} delay={index * 0.06} as="li">
              <Link
                href={item.href}
                className="group flex h-full flex-col rounded-xl p-3 transition-colors hover:bg-[#FCFAEF] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0097b2] dark:hover:bg-[#1C1F1E]"
              >
