...
export default function CallToAction() {
  return (
    <section className="py-16 md:py-24 bg-gradient-to-r from-[#0097b2] to-[#0F4C5C] text-white">
      <div className="container mx-auto px-4 text-center">
        <div className="max-w-3xl mx-auto">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={index} className="flex items-start">
                  <span className="text-[#F5C94D] mr-3 mt-1">•</span>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Button 
              className="bg-[#FCFAEF] text-[#0097b2] hover:bg-[#F5C94D] hover:text-[#1C1F1E] px-6 py-6 h-auto text-lg"
            >
            ...
            <Button 
              className="bg-[#eeba2b] text-[#FCFAEF] hover:bg-[#F5C94D] hover:text-[#1C1F1E] px-6 py-6 h-auto text-lg"
            >
            ...
            <Button 
              variant="outline" 
              className="border-[#FCFAEF] text-[#0097b2] hover:text-[#F5C94D] hover:bg-[#FCFAEF]/10 px-6 py-6 h-auto text-lg"
            >
