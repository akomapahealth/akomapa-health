...
export default function GivebutterCheckout({
  ...
  return (
    ...
    >
      {/* Wide bordered frame; content stays in a shared 560px column. */}
      <div className="mx-auto flex w-full max-w-[560px] flex-col items-stretch">
        ...
        <div
          className="mx-auto mt-6 grid min-h-44 w-full place-items-center"
        ...
        >
          {loadState === "loading" || loadState === "idle" ? (
            <div
              role="status"
              aria-live="polite"
              className="flex min-h-44 w-full flex-col items-center justify-center gap-3 text-sm text-[#2F3332]/75 dark:text-[#E6E7E7]/75"
            >
        ...
        <div className="mt-6 w-full border-t border-[#1C1F1E]/10 pt-5 text-center dark:border-[#FCFAEF]/15">
          <a
