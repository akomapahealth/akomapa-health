...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    bio: "Dr. Ochieng specializes in public health education and community-based interventions. She has developed innovative health education programs that have been implemented across East Africa. She holds a PhD in Health Education from Makerere University and has published extensively on effective health communication strategies.",
    image: "/images/team/sarah-ochieng.jpg",
    socialLinks: {
      linkedin: "https://linkedin.com/in/sarah-ochieng",
      twitter: "https://twitter.com/sarah_ochieng",
      email: "sarah.ochieng@akomapa.org"
    }
  },
  {
    id: "3",
    name: "Dr. Emmanuel Kwarteng",
    title: "Director of Professional Development",
    bio: "Dr. Kwarteng leads our healthcare workforce training initiatives. With a background in medical education and health systems strengthening, he has designed training programs that have equipped thousands of healthcare professionals across West Africa. He previously served as an advisor to Ghana's Ministry of Health on workforce development.",
    image: "/images/team/emmanuel-kwarteng.jpg",
    socialLinks: {
      linkedin: "https://linkedin.com/in/emmanuel-kwarteng",
      email: "emmanuel.kwarteng@akomapa.org"
    }
  },
  {
    id: "4",
    ...
    bio: "Dr. Nkrumah oversees our research portfolio, focusing on generating evidence to improve healthcare delivery in resource-limited settings. She is an epidemiologist with expertise in infectious diseases and health systems research. Before joining Akomapa, she was a senior researcher at the Ghana Health Service and has led multiple international research collaborations.",
    image: "/images/team/aisha-nkrumah.jpg",
    socialLinks: {
      linkedin: "https://linkedin.com/in/aisha-nkrumah",
      twitter: "https://twitter.com/aisha_nkrumah",
      email: "aisha.nkrumah@akomapa.org"
    }
  },
  {
    id: "5",
